...
(function (dressup_game) {
    ...
    var Config = (function () {
        ...
        Config.height = 600;
        Config.links = {
            'small_logo': 'http://girlieroom.com/',
            'btn_more_seasons': 'http://www.dressupgames.com/',
            'btn_free_games': 'http://girlieroom.com/freegames/page1/',
            'btn_fb': 'https://www.facebook.com/EmilyDiary',
            'btn_partner': 'http://www.y8.com/',
        };
        Config.parts = {
            ...
            'btn_m1_opt6': { 'path': ['model_1/opt_6'], 'exclude': [], 'allowHide': false },
            'btn_m1_opt7': { 'path': ['model_1/opt_7'], 'exclude': [], 'allowHide': false },
